package com.kyle.kyleaigenscreenshot.mq.consumer;
...
import com.kyle.kyleaigenscreenshot.service.impl.ScreenshotServiceImpl;
...
public class ScreenshotTaskConsumer {
    ...
    public void handleScreenshotMessage(
        ...
        // 更新应用封面
        appServiceProxy.updateAppCover(message.getAppId(), cosUrl);
