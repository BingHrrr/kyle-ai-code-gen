package com.kyle.kyleaigenapp.controller;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;

import com.kyle.kyleaigenapp.ratelimiter.RateLimit;
import com.kyle.kyleaigenapp.ratelimiter.RateLimitType;
import com.kyle.kyleaigenapp.service.AppService;
import com.kyle.kyleaigenapp.service.ProjectDownloadService;
import com.kyle.kyleaigenclient.proxy.UserServiceProxy;
import com.kyle.kyleaigencommon.annotation.AuthCheck;
import com.kyle.kyleaigencommon.common.BaseResponse;
import com.kyle.kyleaigencommon.common.DeleteRequest;
import com.kyle.kyleaigencommon.common.ResultUtils;
import com.kyle.kyleaigencommon.constant.AppConstant;
import com.kyle.kyleaigencommon.constant.UserConstant;
...
import com.kyle.kyleaigenmodel.model.dto.app.*;
...
public class AppController {
    ...
    public Flux<ServerSentEvent<String>> chatToGenCode(@RequestParam Long appId,
        ...
        return contentFlux
                .map(chunk -> {
                    Map<String, String> dataWrapper = Map.of("d", chunk);
                    String jsonStr = JSONUtil.toJsonStr(dataWrapper);
                    return ServerSentEvent.<String>builder()
                            .data(jsonStr)
                            .build();
                })
                // 在最后拼接一个结束事件 Mono.just()
